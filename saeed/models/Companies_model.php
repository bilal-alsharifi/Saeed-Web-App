...
class Companies_model extends Model {
    ...
    function getCompany($companyID) {
        $query = "SELECT * FROM company WHERE id = :companyID LIMIT 1;";
    ...
    function addCompany() {
        ...
        $query = "INSERT INTO company VALUES (NULL, :name, :phone, :address);";
        $sth = $this->db->prepare($query);
    ...
    function editCompany($companyID) {
        ...
        $query = "UPDATE company SET name = :name, phone = :phone, address = :address WHERE id = :companyID;";
        $sth = $this->db->prepare($query);
        $sth->bindParam('name', $name);
        $sth->bindParam('phone', $phone);
        $sth->bindParam('address', $address);
    ...
    function getAllCompaniesForDataTables() {
         ...
         */
        $aColumns = array('id', 'name', 'phone', 'address');
